...
RUN_ROOT=/root/autodl-tmp/gva_factor_experiments/runs_newdata/csi1000_main_compare_$(date +%Y%m%d_%H%M%S)
...
echo "METHODS=AlphaGen-PPO,Critic-GVA,Full-GVA"
echo "SEEDS=0,1,2"
...
for seed in 0 1 2; do
  ...
  launch critic_gva25_s${seed} \
    --random_seeds=${seed} \
    --method_name=critic_gva25_s${seed} \
    --use_custom_ppo=True \
