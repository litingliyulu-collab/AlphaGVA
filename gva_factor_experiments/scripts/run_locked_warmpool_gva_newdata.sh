...
RUN_ROOT=/root/alpha_1203/gva_factor_experiments/runs_newdata/locked_warmpool_gva_$(date +%Y%m%d_%H%M%S)
...
launch() {
  local seed="$1"
  local name="locked_warm_full_gva25_s${seed}"
