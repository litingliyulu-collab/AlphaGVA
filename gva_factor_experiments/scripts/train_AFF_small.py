...
def main(
    ...
    for seed in seeds:
        ...
        coll.collect_target_num(netG,netM,z,data,target,metric,
                                target_num=800,reset_net=True,drop_invalid=False,
                                randomly = False,
                                random_method = random_call,max_iter = 40)
        ...
        while len(zoo_blds)<cfg.num_factors:
            ...
            coll.reset(data,target,metric)
            coll.collect_target_num(netG,netM,z,data,target,metric,
                                    target_num=300,reset_net=False,drop_invalid=False,
                                    randomly = False,
                                    random_method = random_call,max_iter = 30)
